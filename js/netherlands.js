const netherlandsBtn = document.getElementById("netherlands");
const newsDetail = document.getElementById("newsDetail");

var newsDataArr = [];

const API_KEY = "76646ac460794ef69acf3bba25c1c60f";
const NETHERLANDS_NEWS = "https://newsapi.org/v2/top-headlines?country=nl&apiKey=";

const fetchNetherlandsNews = async () => {
    const response = await fetch(NETHERLANDS_NEWS + API_KEY);
    newsDataArr = [];
